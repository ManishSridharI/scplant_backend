...
class JobAnnotateAndPlotFileOutputModel(models.Model):
    ...
    job_annotate_and_plot_log_file = models.FileField(upload_to=job_annotate_and_plot_log_file_upload_directory, storage=OverwriteStorage(), validators=[FileExtensionValidator(allowed_extensions=['txt'])])
    ...
    job_annotate_and_plot_annotate_tsne_file = models.FileField(upload_to=job_annotate_and_plot_annotate_tsne_file_upload_directory, storage=OverwriteStorage(), validators=[FileExtensionValidator(allowed_extensions=['pdf'])])
    job_annotate_and_plot_annotate_umap_file = models.FileField(upload_to=job_annotate_and_plot_annotate_umap_file_upload_directory, storage=OverwriteStorage(), validators=[FileExtensionValidator(allowed_extensions=['pdf'])])
    job_annotate_and_plot_top3_genes_dotplot_file = models.FileField(upload_to=job_annotate_and_plot_top3_genes_dotplot_file_upload_directory, storage=OverwriteStorage(), validators=[FileExtensionValidator(allowed_extensions=['pdf'])])
